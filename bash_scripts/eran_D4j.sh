...
python ${ATG}defects_lib.py -p ${p_name} -F fix -o /home/ise/eran/eran_D4j/${p_name}_t=2 -e /home/ise/eran/evosuite/jar/evosuite-1.0.5.jar -b 180 -l 1 -u 100 -t package -c F -k U -r 2-400 -M U -f F

python ${ATG}defects_lib.py -p ${p_name} -F fix -o /home/ise/eran/eran_D4j/${p_name}_t=5 -e /home/ise/eran/evosuite/jar/evosuite-1.0.5.jar -b 180 -l 1 -u 100 -t package -c F -k U -r 2-400 -M U -f F

python ${ATG}defects_lib.py -p ${p_name} -F fix -o /home/ise/eran/eran_D4j/${p_name}_t=10 -e /home/ise/eran/evosuite/jar/evosuite-1.0.5.jar -b 180 -l 1 -u 100 -t package -c F -k U -r 2-400 -M U -f F
